...
function calculate() {
    ...
    document.getElementById("resultCost").innerHTML = "Â£".concat(cost);
	document.getElementById("resultProfit").innerHTML = "Â£".concat(profit);
    changeTab(6);
}
...
function esure() {
	document.getElementById("insurancePayout").value = '1300';
	changeInsuranceImage('esure.png');
	changeTab(2);
}
function lv() {
	document.getElementById("insurancePayout").value = '1350';
